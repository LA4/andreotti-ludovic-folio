...
export const IMAGESI = [
  ...
  },
  {
    ...
    source: lit3D,
    description:
      "Cette chambre est une représentation en 3D. C’était un bon entrainement pour les matières en tissus.",
  },
  {
    title: "Dragons",
    source: dragons,
    description:
      "Illustration créée pour une Book-stragameuse, le défis était d’illustrer un publication sur le thème du livre ‘Fourth Wing’",
  },
  {
    title: "Homme et son chat",
    source: hommeetchat,
    description:
      "Cette illustration est un dessin offert à l'occasion d’un anniversaire. Il représente un homme chasseur de pokémon et son compagnon chat.",
  },
  {
    title: "Hypolove",
    source: hypolove,
    description:
      "Le premier dessin que j’ai réalisé sur le logiciel procreate. Il représente un hippocampe.",
  },
  {
    title: "Inktober - Rêve",
    source: inktober1,
  ...
  },
  {
    title: "Pokéballs",
    source: pokeball96,
    description: "Représentations en 3D de pokéballs.",
  },
  {
    title: "Pokécenter",
    source: pokecenter,
    description:
      "Cette image est une représentation 3D stylisée d’un point de vue sur un centre pokémon.",
  },
  {
  ...
  },
  {
    ...
    source: supportermarseillais,
    description:
      "Ce dessin représente un homme, supporter d’un club de l’OM avec en fond le vélodrome.",
  },
  {
    title: "Various Crew",
    source: variouscrew,
    description: "Bannière réalisée pour le streamer Various crew.",
  },
  {
    title: "Pokeballs Wallpaper",
    source: wallpaperpokemon,
